...
Nova is a local personal AI agent assistant. It runs on your machine, uses your
...
- [Tool Overview](tools/index.md) -- what Nova can do for you

## Skills

- [Skills Overview](skills/index.md) -- extend Nova with reusable skills
...
- [Memory Overview](memory/index.md) -- how Nova remembers across sessions
