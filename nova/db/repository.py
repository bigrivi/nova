...
class NovaRepository(Protocol):
    ...
    async def get_memory_by_key(self, key: str, scope: str, session_id: str | None = None, owner_agent_key: str | None = None) -> dict | None: ...
    ...
    async def delete_memory_by_key(self, key: str, scope: str, session_id: str | None = None, owner_agent_key: str | None = None) -> int: ...
